            ...
            <nav>
                ...
                <div className="profile">
                    ...
                    <ul className={` profile-link ${showDropdown ? "show" : ""}`}>
                        <li>
                            <Link href="/portal/user/setting/profile">
                                <i className="bx bxs-user-circle icon"/> Profile
                            </Link>
                        </li>
                        <li>
                            <Link href="/portal/user/setting/account">
                                <i className="bx bxs-cog"/> Account Settings
                            </Link>
                        </li>
                        <li>
                            <Link href="/portal/user/setting/password">
