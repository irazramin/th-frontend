        ...
        <>
            <nav>
                ...
                <div className="profile">
                    <img  onClick={() => setShowDropdown(!showDropdown)}  style={{height: '36px', width: '36px'}} src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cGVvcGxlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="" />
