          ...
          <div>
              ...
              <section className='hero-section' id='hero-section'>
                  <div className="hero-content">
                    ...
                    <div className="hero-content">
                        <div>
                            <h1>Find your next job, First<span style={{color:"var(--green)", fontSize:"60px"}}>.</span></h1>
                  ...
                  <div className="top-candidate">
                      <div className="candidates">
                              <div className="candidate card">
                                  <img src="https://www.freepnglogos.com/uploads/company-logo-png/company-logo-transparent-png-19.png" alt="" className="candidate-img" />
