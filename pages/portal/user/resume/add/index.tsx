...
import {faAngleDown, faArrowDown, faArrowLeft} from "@fortawesome/free-solid-svg-icons";
                                                   ...
                                                   <div className="row">
                                                       <div className="col-md-6 col-sm-12 form-group">
                                                           <div className="input-icon">
                                                               ...
                                                               })} type="text" name="examName" placeholder="Your name"/>
                                                       ...
                                                       <div className="col-md-6 col-sm-12 form-group">
                                                           <div className="input-icon">
                                                               ...
                                                               })} type="text" name="examName" placeholder="Designation"/>
