...
const Experience = () => {
    ...
    const {userExperienceList = {data: [], meta: null}, userExperienceDelete = {time: null}, isLoading = false} = useSelector(
                    ...
                    >
                        {userExperienceList?.data?.length > 0 && userExperienceList.data.map((userExperience: any, userExperienceIndex: number) => (
                            <tr key={userExperienceIndex}>
                                ...
                                <td>{userExperience.organisation}</td>
                                ...
                                <td>{new Date(userExperience.start).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</td>
                                <td>{new Date(userExperience.end).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</td>
                                <td>
                                    <ActionButton
