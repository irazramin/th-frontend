...
const EducationLIst = () => {
    ...
    const {
        userEducationList = {data: [], meta: null},
        userEducationDelete = {time: null},
        isLoading = false
    } = useSelector(
                    ...
                    >
                        {userEducationList?.data?.length > 0 && userEducationList.data.map((userEducation: any, userEducationIndex: number) => (
                            <tr key={userEducationIndex}>
                                ...
                                <td>{new Date(userEducation.start).toLocaleDateString('en-US', {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric'
                                })}</td>
                                <td>{new Date(userEducation.end).toLocaleDateString('en-US', {
                                    year: 'numeric',
                                    month: 'long',
                                    day: 'numeric'
                                })}</td>
